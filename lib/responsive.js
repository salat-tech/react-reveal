...
var _withReveal = _interopRequireDefault(require("./withReveal"));

var _excluded = ["effect", "breakpoint"];
...
function responsive(WrappedComponent) {
  var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {
    breakpoint: '768px'
      ...
      breakpoint = _ref$breakpoint === void 0 ? '768px' : _ref$breakpoint,
      rest = _objectWithoutProperties(_ref, _excluded);

  var RevealedComponent = (0, _withReveal["default"])(WrappedComponent, effect);
  return /*#__PURE__*/function (_React$Component) {
    ...
    _createClass(_class, [{
      ...
      key: "newQuery",
      value: function newQuery(query) {
        this.unlisten();

        if ('matchMedia' in window) {
          this.mql = window.matchMedia("(min-width: ".concat(breakpoint, ")"));
      ...
      value: function render() {
        return /*#__PURE__*/_react["default"].createElement(RevealedComponent, _extends({}, this.props, {
