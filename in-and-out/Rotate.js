...
function make(reverse, _ref) {
  ...
  lookup[checksum] = (0, _globals.animation)("\n    ".concat(!reverse ? 'from' : 'to', " { opacity: 0; transform-origin: ").concat(origin, "; transform: rotate3d(0, 0, 1, ").concat(angle, ");}\n    ").concat(reverse ? 'from' : 'to', " { opacity: 1; transform-origin: ").concat(origin, "; transform: none;}\n  "));
